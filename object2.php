...
class Training{
	...
	function getCGPA($cgpa){
		...
		if($grade==null){
			...
			return "Welcome ".$name.". You have enroll ".$course.". Based on your
			CGPA (".$cgpa."), your grade is ". $grade;
		}
	}


	function calculatedGSTService($item1,$item2,$gst,$service){
...
echo $train->getCGPA(3.5).'<br/>';

echo $train->calculatedGSTService(1000.00,5000.00,0.06,0.10);
